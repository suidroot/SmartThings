 ...
 *
 *  Developer's Notes
 *  Raw Description 0 0 0x1001 0 0 0 a 0x25 0x32 0x27 0x60 0x70 0x85 0x72 0x86 0xEF 0x82
 *
 ...
 *  0x60    COMMAND_CLASS_MULTI_CHANNEL		V2
...
metadata {
	...
	attribute "power4", "number"
	attribute "energy4", "number"
	...
	attribute "power6", "number"
	attribute "energy6", "number"

	command "reset"

	fingerprint deviceId: "0x1001", inClusters: "0x25, 0x32, 0x27, 0x60, 0x70, 0x85, 0x72, 0x86, 0xEF, 0x82"
    }
	...
	main (["switch"])
	details(["switch","energy","reset","configure","refresh"])
    }
...
def updated() {
    ...
    if (state.debug) log.debug "updated(disableOnOff: ${disableOnOff}(${state.onOffDisabled}), reportInterval: ${reportInterval}, switchAll: ${switchAll}, debugOutput: ${debugOutput}(${state.debug}))"
    response(configure())
}
...
def parse(String description) {
    ...
    def cmd = zwave.parse(description, [0x20: 1, 0x25: 1, 0x32 : 3, 0x27 : 1, 0x70 : 1, 0x60 : 3, 0x85 : 2, 0x72 : 2, 0x86 : 1, 0xEF : 1, 0x82 : 1])
...
def zwaveEvent(physicalgraph.zwave.commands.multichannelv3.MultiChannelCmdEncap cmd) {
        def encapsulatedCommand = cmd.encapsulatedCommand([0x20: 1, 0x25: 1, 0x32 : 3, 0x27 : 1, 0x70 : 1, 0x60 : 3, 0x85 : 2, 0x72 : 2, 0x86 : 1, 0xEF : 1, 0x82 : 1]) // can specify command class versions here like in zwave.parse
...
//[0x20: 1, 0x25: 1, 0x32 : 3, 0x27 : 1, 0x70 : 1, 0x60 : 3, 0x85 : 2, 0x72 : 2, 0x86 : 1, 0xEF : 1, 0x82 : 1]
        def encapsulatedCommand = cmd.encapsulatedCommand([0x20: 1, 0x25: 1, 0x32 : 3, 0x27 : 1, 0x70 : 1, 0x60 : 3, 0x85 : 2, 0x72 : 2, 0x86 : 1, 0xEF : 1, 0x82 : 1]) // can specify command class versions here like in zwave.parse
